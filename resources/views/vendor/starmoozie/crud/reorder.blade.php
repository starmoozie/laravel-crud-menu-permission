...
<div class="row mt-4">
    <div class="{{ $crud->getReorderContentClass() }}">
        ...
        <button id="toArray" class="btn btn-outline-primary btn-sm shadow-sm" data-style="zoom-in"><i class="la la-save"></i> {{ trans('starmoozie::crud.save') }}</button>
    </div>
</div>
@endsection
...
<script type="text/javascript">
    ...
    $('#toArray').click(function(e){
        ...
        .fail(function() {
            new Noty({
                type: "error",
                text: "<strong>{{ trans('starmoozie::crud.reorder_error_title') }}</strong><br>{{ trans('starmoozie::crud.reorder_error_message') }}"
            }).show();
          })
        .always(function() {
