...
@php
    ...
    switch($field['relation_type']) {
        ...
        case 'MorphMany':
            ...
            // when true, starmoozie ensures that the connecting entry is deleted when un-selected from relation
        ...
        case 'MorphTo':
        case 'MorphedByMany':
            abort(500, "The relationship field does not support {$field['relation_type']} at the moment, nobody asked for it yet. If you do, please let us know here - https://github.com/Laravel-Starmoozie/CRUD/issues");
            // TODO: complex interface that allows you to select entries from multiple models
        default:
            abort(500, "Unknown relationship type used with the 'relationship' field. Please let the Starmoozie team know of this new Laravel relationship, so they add support for it.");
            break;
    }
@endphp
